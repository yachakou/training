...
public class ReversStringWithoutAffectingSpecialChar {
    ...
    private static String reverseWithoutCHangingSpecialChars(String special) {
    ...
    private static String reverseWithoutCHangingSpecialCharsSecondMethod(String special) {
